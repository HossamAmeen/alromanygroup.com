...
<script>
    ...
    $("#avatar").fileinput({
        ...
        defaultPreviewContent: '<img src="{{URL::asset($mUser->img)}}" alt="Your Avatar" style="width:160px">',
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input placeholder='اتركها فارغة فى حالة عدم التغير' type="password" id="password" name="password" class="form-control" >
                    </div>


                    <div class="form-group col-md-6">
                        <label for="password-confirmation">تأكيد كلمة المرور</label>
                        <input placeholder='اتركها فارغة فى حالة عدم التغير' type="password" id="password-confirmation" name="password_confirmation" class="form-control" >
                    </div>
                    ...
                    <div class="col-xs-12 notes">
                        <p><span class="red">*</span>يسمح فقط بالأرقام و الحروف لاسم المستخدم</p>
                    </div>
                    {!!Form::close()!!}
                </div> <!-- end panel body -->
