        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open( array('id'=>'newsForm','url'=>'admin/news/add',  'enctype'=> 'multipart/form-data'  ))!!}
                    ...
                    <input type="submit" class="col-md-offset-3 col-md-6 btn btn-info" value="إضافة خبر" />
