   ...
   This must be loaded before fileinput.min.js -->
    ...
    <script>
        ...
        $("#img").fileinput({
            ...
            defaultPreviewContent: '<img src="{{URL::asset($mService->img)}}" alt="صورة الخدمة" style="width:160px">',
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">{{$pageTitle}}</h3>
        	 ...
        	 {!! Form::model( $mService ,array('method' => 'put', 'enctype'=> 'multipart/form-data') )!!}
