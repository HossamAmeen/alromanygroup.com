        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">إضافة متابعة جديدة</h3>
                </div>

                <div class="panel-body">
                    {!! Form::open( array('id'=>'newsForm','url'=>'admin/follows/add',  'enctype'=> 'multipart/form-data'  ))!!}


                    <div class="form-group col-md-6">
                        <label for="title">عنوان المتابعه</label>
                        {!! Form::text($name = 'title', null, $attributes = array(
                            'id'=>'title',
                            'class'=>'form-control',
                            'placeholder'=>'عنوان المتابعه',
                            'required'=>'required',
                            'max-length'=>'99'
                        )) !!}
                    </div>
                    <div class="form-group col-md-6">
                        <label for="content">اختر مشروع متعلق بالمتابعه</label>
                    ...
                    <input type="submit" class="col-md-offset-3 col-md-6 btn btn-info" value="إضافة متابعه" />
