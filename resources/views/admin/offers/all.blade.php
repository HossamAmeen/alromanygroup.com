                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a  href="{{URL::to('admin/offers/'.$row->id .'/update')}}"><button class="btn btn-xs btn-warning" title="تعديل"><i class="fa fa-pencil-square-o"></i></button></a>
                                                    <a class="check" href="{{URL::to('admin/offers/'.$row->id .'/delete')}}"><button class="btn btn-xs btn-danger" title="حذف"><i class="fa fa-minus"></i></button></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
